...
#radio = RadioButtons(cax, ('Triangle','Creneau'),(True, False))
radio = RadioButtons(cax, ('Triangle','Creneau'), active=0) # pour activer le 1er bouton
#radio = RadioButtons(cax, ('Triangle','Creneau'), active=1) # pour activer le 2e bouton
